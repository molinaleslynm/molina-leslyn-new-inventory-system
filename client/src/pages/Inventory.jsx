...
const Inventory = () => {
    ...
    return (
        <>
            <div className="m-3 flex items-center justify-center bg-purple-200">
                <div className="w-full text-5xl text-center text-purple-300 bg-black py-2 font-bold">Sample Inventory</div>
            </div>

            <div className="m-3 flex items-center justify-center bg-black">
                <table className="border-2 border-black bg-purple-300">
                    <thead>
                        <tr>
                            <th className="text-purple-600">Product ID</th>
                            <th className="text-purple-600">Product Name</th>
                            <th className="text-purple-600">Quantity</th>
                            <th className="text-purple-600">Unit</th>
                            <th className="text-purple-600">Price</th>
                            <th className="text-purple-600">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        {
                                ...
                                <tr key={index}>
                                    ...
                                    <td>
                                        <button
                                            ...
                                            className="mr-2 border-2 border-blue-500 p-2 rounded bg-gray-400 text-white hover:bg-blue-500"
                                        >
                                            Edit
                                        </button>
                                        <button
                                            onClick={() => handleDelete(element.product_id)}
                                            className="border-2 border-red-500 p-2 rounded bg-purple-400 text-white hover:bg-red-500"
                                        >
                                            Delete
                                        </button>
                                    </td>
            ...
            <div className="m-3 flex items-center justify-center">
                <button
                    type="button"
                    className="p-2 rounded bg-purple-400 border border-pink-200 text-white hover:bg-black hover:border-purple-400"
